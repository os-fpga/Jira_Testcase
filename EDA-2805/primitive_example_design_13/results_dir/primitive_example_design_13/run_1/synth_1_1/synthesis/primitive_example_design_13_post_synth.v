...
module primitive_example_design_13(clk_in, pll_clk, reset, i1, i2, load_word, channel_bond_sync_in, data_out, OE_OUT, CHANNEL_BOND_SYNC_OUT);
  ...
  LUT6 #(
    ...
    .A({ \$iopadmap$i2 [0], \$iopadmap$i1 [0], \$iopadmap$i1 [1], \$iopadmap$i1 [2], \$iopadmap$i2 [2:1] }),
  ...
  CLK_BUF \$auto$clkbufmap.cc:265:execute$732  (
    .I(\$iopadmap$clk_in ),
    .O(\$auto$clkbufmap.cc:298:execute$734 )
  );
  (* keep = 32'h00000001 *)
  (* module_not_derived = 32'h00000001 *)
  ...
  O_SERDES #(
    ...
    .CLK_IN(\$auto$clkbufmap.cc:298:execute$734 ),
    .D(data_in),
