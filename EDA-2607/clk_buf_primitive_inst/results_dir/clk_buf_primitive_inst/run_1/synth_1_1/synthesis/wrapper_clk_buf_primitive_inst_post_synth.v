...
module clk_buf_primitive_inst(clock_input, clock_output);
  ...
  (* src = "/nfs_scratch/scratch/CompilerValidation/abdul_hameed/19march-jiracheck/clk_buf_primitive_inst/results_dir/.././rtl/clk_buf_primitive_inst.v:2.9-2.20" *)
  wire clock_input;
  fabric_clk_buf_primitive_inst \$auto$rs_design_edit.cc:658:execute$398  (
  );
  interface_clk_buf_primitive_inst \$auto$rs_design_edit.cc:660:execute$399  (
    .clock_input(clock_input),
    .clock_output(clock_output)
  );
endmodule

module interface_clk_buf_primitive_inst(clock_input, clock_output);
  output clock_output;
  input clock_input;
  wire \$iopadmap$clock_input ;
  wire \$iopadmap$clock_output ;
