...
set input_file_path "PNR_SIM/run_1/synth_1_1/impl_1_1_1/routing/ram_simple_dp_dc_512x32_post_route.v"
set output_file_path "PNR_SIM/run_1/synth_1_1/impl_1_1_1/routing/ram_simple_dp_dc_512x32_post_route.v"
# Print the current working directory
puts "Current working directory: [pwd]"
# Call the Python script
exec python python_bin_to_hex.py $input_file_path $output_file_path

puts "Modification completed."
simulation_options compilation icarus -Wtimescale pnr
simulate pnr icarus
sta
power
bitstream
