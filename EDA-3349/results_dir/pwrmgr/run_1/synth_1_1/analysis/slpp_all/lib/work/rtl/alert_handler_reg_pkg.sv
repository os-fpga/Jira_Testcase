...
package alert_handler_reg_pkg;
  ...
  // Register Address
  parameter logic [9:0] ALERT_HANDLER_INTR_STATE_OFFSET = 10'h0;
  parameter logic [9:0] ALERT_HANDLER_INTR_ENABLE_OFFSET = 10'h4;
  parameter logic [9:0] ALERT_HANDLER_INTR_TEST_OFFSET = 10'h8;
  parameter logic [9:0] ALERT_HANDLER_REGEN_OFFSET = 10'hc;
  parameter logic [9:0] ALERT_HANDLER_PING_TIMEOUT_CYC_OFFSET = 10'h10;
  parameter logic [9:0] ALERT_HANDLER_ALERT_EN_OFFSET = 10'h20;
  parameter logic [9:0] ALERT_HANDLER_ALERT_CLASS_0_OFFSET = 10'h120;
  parameter logic [9:0] ALERT_HANDLER_ALERT_CLASS_1_OFFSET = 10'h124;
  parameter logic [9:0] ALERT_HANDLER_ALERT_CAUSE_OFFSET = 10'h220;
  parameter logic [9:0] ALERT_HANDLER_LOC_ALERT_EN_OFFSET = 10'h320;
  parameter logic [9:0] ALERT_HANDLER_LOC_ALERT_CLASS_OFFSET = 10'h324;
  parameter logic [9:0] ALERT_HANDLER_LOC_ALERT_CAUSE_OFFSET = 10'h328;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_CTRL_OFFSET = 10'h32c;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_CLREN_OFFSET = 10'h330;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_CLR_OFFSET = 10'h334;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_ACCUM_CNT_OFFSET = 10'h338;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_ACCUM_THRESH_OFFSET = 10'h33c;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_TIMEOUT_CYC_OFFSET = 10'h340;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_PHASE0_CYC_OFFSET = 10'h344;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_PHASE1_CYC_OFFSET = 10'h348;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_PHASE2_CYC_OFFSET = 10'h34c;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_PHASE3_CYC_OFFSET = 10'h350;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_ESC_CNT_OFFSET = 10'h354;
  parameter logic [9:0] ALERT_HANDLER_CLASSA_STATE_OFFSET = 10'h358;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_CTRL_OFFSET = 10'h35c;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_CLREN_OFFSET = 10'h360;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_CLR_OFFSET = 10'h364;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_ACCUM_CNT_OFFSET = 10'h368;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_ACCUM_THRESH_OFFSET = 10'h36c;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_TIMEOUT_CYC_OFFSET = 10'h370;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_PHASE0_CYC_OFFSET = 10'h374;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_PHASE1_CYC_OFFSET = 10'h378;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_PHASE2_CYC_OFFSET = 10'h37c;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_PHASE3_CYC_OFFSET = 10'h380;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_ESC_CNT_OFFSET = 10'h384;
  parameter logic [9:0] ALERT_HANDLER_CLASSB_STATE_OFFSET = 10'h388;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_CTRL_OFFSET = 10'h38c;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_CLREN_OFFSET = 10'h390;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_CLR_OFFSET = 10'h394;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_ACCUM_CNT_OFFSET = 10'h398;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_ACCUM_THRESH_OFFSET = 10'h39c;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_TIMEOUT_CYC_OFFSET = 10'h3a0;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_PHASE0_CYC_OFFSET = 10'h3a4;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_PHASE1_CYC_OFFSET = 10'h3a8;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_PHASE2_CYC_OFFSET = 10'h3ac;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_PHASE3_CYC_OFFSET = 10'h3b0;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_ESC_CNT_OFFSET = 10'h3b4;
  parameter logic [9:0] ALERT_HANDLER_CLASSC_STATE_OFFSET = 10'h3b8;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_CTRL_OFFSET = 10'h3bc;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_CLREN_OFFSET = 10'h3c0;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_CLR_OFFSET = 10'h3c4;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_ACCUM_CNT_OFFSET = 10'h3c8;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_ACCUM_THRESH_OFFSET = 10'h3cc;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_TIMEOUT_CYC_OFFSET = 10'h3d0;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_PHASE0_CYC_OFFSET = 10'h3d4;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_PHASE1_CYC_OFFSET = 10'h3d8;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_PHASE2_CYC_OFFSET = 10'h3dc;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_PHASE3_CYC_OFFSET = 10'h3e0;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_ESC_CNT_OFFSET = 10'h3e4;
  parameter logic [9:0] ALERT_HANDLER_CLASSD_STATE_OFFSET = 10'h3e8;
  ...
  parameter logic [3:0] ALERT_HANDLER_PERMIT [60] = '{
    4'b0001, // index[ 0] ALERT_HANDLER_INTR_STATE
    4'b0001, // index[ 1] ALERT_HANDLER_INTR_ENABLE
    4'b0001, // index[ 2] ALERT_HANDLER_INTR_TEST
    4'b0001, // index[ 3] ALERT_HANDLER_REGEN
    4'b0111, // index[ 4] ALERT_HANDLER_PING_TIMEOUT_CYC
    4'b0111, // index[ 5] ALERT_HANDLER_ALERT_EN
    4'b1111, // index[ 6] ALERT_HANDLER_ALERT_CLASS_0
    4'b0001, // index[ 7] ALERT_HANDLER_ALERT_CLASS_1
    4'b0111, // index[ 8] ALERT_HANDLER_ALERT_CAUSE
    4'b0001, // index[ 9] ALERT_HANDLER_LOC_ALERT_EN
    4'b0001, // index[10] ALERT_HANDLER_LOC_ALERT_CLASS
    4'b0001, // index[11] ALERT_HANDLER_LOC_ALERT_CAUSE
    4'b0011, // index[12] ALERT_HANDLER_CLASSA_CTRL
    4'b0001, // index[13] ALERT_HANDLER_CLASSA_CLREN
    4'b0001, // index[14] ALERT_HANDLER_CLASSA_CLR
    4'b0011, // index[15] ALERT_HANDLER_CLASSA_ACCUM_CNT
    4'b0011, // index[16] ALERT_HANDLER_CLASSA_ACCUM_THRESH
    4'b1111, // index[17] ALERT_HANDLER_CLASSA_TIMEOUT_CYC
    4'b1111, // index[18] ALERT_HANDLER_CLASSA_PHASE0_CYC
    4'b1111, // index[19] ALERT_HANDLER_CLASSA_PHASE1_CYC
    4'b1111, // index[20] ALERT_HANDLER_CLASSA_PHASE2_CYC
    4'b1111, // index[21] ALERT_HANDLER_CLASSA_PHASE3_CYC
    4'b1111, // index[22] ALERT_HANDLER_CLASSA_ESC_CNT
    4'b0001, // index[23] ALERT_HANDLER_CLASSA_STATE
    4'b0011, // index[24] ALERT_HANDLER_CLASSB_CTRL
    4'b0001, // index[25] ALERT_HANDLER_CLASSB_CLREN
    4'b0001, // index[26] ALERT_HANDLER_CLASSB_CLR
    4'b0011, // index[27] ALERT_HANDLER_CLASSB_ACCUM_CNT
    4'b0011, // index[28] ALERT_HANDLER_CLASSB_ACCUM_THRESH
    4'b1111, // index[29] ALERT_HANDLER_CLASSB_TIMEOUT_CYC
    4'b1111, // index[30] ALERT_HANDLER_CLASSB_PHASE0_CYC
    4'b1111, // index[31] ALERT_HANDLER_CLASSB_PHASE1_CYC
    4'b1111, // index[32] ALERT_HANDLER_CLASSB_PHASE2_CYC
    4'b1111, // index[33] ALERT_HANDLER_CLASSB_PHASE3_CYC
    4'b1111, // index[34] ALERT_HANDLER_CLASSB_ESC_CNT
    4'b0001, // index[35] ALERT_HANDLER_CLASSB_STATE
    4'b0011, // index[36] ALERT_HANDLER_CLASSC_CTRL
    4'b0001, // index[37] ALERT_HANDLER_CLASSC_CLREN
    4'b0001, // index[38] ALERT_HANDLER_CLASSC_CLR
    4'b0011, // index[39] ALERT_HANDLER_CLASSC_ACCUM_CNT
    4'b0011, // index[40] ALERT_HANDLER_CLASSC_ACCUM_THRESH
    4'b1111, // index[41] ALERT_HANDLER_CLASSC_TIMEOUT_CYC
    4'b1111, // index[42] ALERT_HANDLER_CLASSC_PHASE0_CYC
    4'b1111, // index[43] ALERT_HANDLER_CLASSC_PHASE1_CYC
    4'b1111, // index[44] ALERT_HANDLER_CLASSC_PHASE2_CYC
    4'b1111, // index[45] ALERT_HANDLER_CLASSC_PHASE3_CYC
    4'b1111, // index[46] ALERT_HANDLER_CLASSC_ESC_CNT
    4'b0001, // index[47] ALERT_HANDLER_CLASSC_STATE
    4'b0011, // index[48] ALERT_HANDLER_CLASSD_CTRL
    4'b0001, // index[49] ALERT_HANDLER_CLASSD_CLREN
    4'b0001, // index[50] ALERT_HANDLER_CLASSD_CLR
    4'b0011, // index[51] ALERT_HANDLER_CLASSD_ACCUM_CNT
    4'b0011, // index[52] ALERT_HANDLER_CLASSD_ACCUM_THRESH
    4'b1111, // index[53] ALERT_HANDLER_CLASSD_TIMEOUT_CYC
    4'b1111, // index[54] ALERT_HANDLER_CLASSD_PHASE0_CYC
    4'b1111, // index[55] ALERT_HANDLER_CLASSD_PHASE1_CYC
    4'b1111, // index[56] ALERT_HANDLER_CLASSD_PHASE2_CYC
    4'b1111, // index[57] ALERT_HANDLER_CLASSD_PHASE3_CYC
    4'b1111, // index[58] ALERT_HANDLER_CLASSD_ESC_CNT
    4'b0001 // index[59] ALERT_HANDLER_CLASSD_STATE
  };
endpackage
