...
package pwrmgr_reg_pkg;
  ...
  // Register offsets
  parameter logic [BlockAw-1:0] PWRMGR_INTR_STATE_OFFSET = 7'h0;
  parameter logic [BlockAw-1:0] PWRMGR_INTR_ENABLE_OFFSET = 7'h4;
  parameter logic [BlockAw-1:0] PWRMGR_INTR_TEST_OFFSET = 7'h8;
  parameter logic [BlockAw-1:0] PWRMGR_ALERT_TEST_OFFSET = 7'hc;
  parameter logic [BlockAw-1:0] PWRMGR_CTRL_CFG_REGWEN_OFFSET = 7'h10;
  parameter logic [BlockAw-1:0] PWRMGR_CONTROL_OFFSET = 7'h14;
  parameter logic [BlockAw-1:0] PWRMGR_CFG_CDC_SYNC_OFFSET = 7'h18;
  parameter logic [BlockAw-1:0] PWRMGR_WAKEUP_EN_REGWEN_OFFSET = 7'h1c;
  parameter logic [BlockAw-1:0] PWRMGR_WAKEUP_EN_OFFSET = 7'h20;
  parameter logic [BlockAw-1:0] PWRMGR_WAKE_STATUS_OFFSET = 7'h24;
  parameter logic [BlockAw-1:0] PWRMGR_RESET_EN_REGWEN_OFFSET = 7'h28;
  parameter logic [BlockAw-1:0] PWRMGR_RESET_EN_OFFSET = 7'h2c;
  parameter logic [BlockAw-1:0] PWRMGR_RESET_STATUS_OFFSET = 7'h30;
  parameter logic [BlockAw-1:0] PWRMGR_ESCALATE_RESET_STATUS_OFFSET = 7'h34;
  parameter logic [BlockAw-1:0] PWRMGR_WAKE_INFO_CAPTURE_DIS_OFFSET = 7'h38;
  parameter logic [BlockAw-1:0] PWRMGR_WAKE_INFO_OFFSET = 7'h3c;
  parameter logic [BlockAw-1:0] PWRMGR_FAULT_STATUS_OFFSET = 7'h40;

  // Reset values for hwext registers and their fields
  parameter logic [0:0] PWRMGR_INTR_TEST_RESVAL = 1'h0;
  parameter logic [0:0] PWRMGR_INTR_TEST_WAKEUP_RESVAL = 1'h0;
  parameter logic [0:0] PWRMGR_ALERT_TEST_RESVAL = 1'h0;
  parameter logic [0:0] PWRMGR_ALERT_TEST_FATAL_FAULT_RESVAL = 1'h0;
  parameter logic [0:0] PWRMGR_CTRL_CFG_REGWEN_RESVAL = 1'h1;
  parameter logic [0:0] PWRMGR_CTRL_CFG_REGWEN_EN_RESVAL = 1'h1;
  parameter logic [7:0] PWRMGR_WAKE_INFO_RESVAL = 8'h0;
  parameter logic [5:0] PWRMGR_WAKE_INFO_REASONS_RESVAL = 6'h0;
  parameter logic [0:0] PWRMGR_WAKE_INFO_FALL_THROUGH_RESVAL = 1'h0;
  parameter logic [0:0] PWRMGR_WAKE_INFO_ABORT_RESVAL = 1'h0;
  ...
  parameter logic [3:0] PWRMGR_PERMIT [17] = '{
    4'b0001, // index[ 0] PWRMGR_INTR_STATE
    4'b0001, // index[ 1] PWRMGR_INTR_ENABLE
    4'b0001, // index[ 2] PWRMGR_INTR_TEST
    4'b0001, // index[ 3] PWRMGR_ALERT_TEST
    4'b0001, // index[ 4] PWRMGR_CTRL_CFG_REGWEN
    4'b0011, // index[ 5] PWRMGR_CONTROL
    4'b0001, // index[ 6] PWRMGR_CFG_CDC_SYNC
    4'b0001, // index[ 7] PWRMGR_WAKEUP_EN_REGWEN
    4'b0001, // index[ 8] PWRMGR_WAKEUP_EN
    4'b0001, // index[ 9] PWRMGR_WAKE_STATUS
    4'b0001, // index[10] PWRMGR_RESET_EN_REGWEN
    4'b0001, // index[11] PWRMGR_RESET_EN
    4'b0001, // index[12] PWRMGR_RESET_STATUS
    4'b0001, // index[13] PWRMGR_ESCALATE_RESET_STATUS
    4'b0001, // index[14] PWRMGR_WAKE_INFO_CAPTURE_DIS
    4'b0001, // index[15] PWRMGR_WAKE_INFO
    4'b0001 // index[16] PWRMGR_FAULT_STATUS
  };
