...
module gbox_clk_as_data(clk, din, dout);
  ...
  O_BUFT \$auto_429.o_buft  (
    .I(\$auto_429.dout_obuf ),
    .O(\$auto_429.dout ),
    .T(\$flatten$auto_429.$auto_428 )
  );
  ...
  assign \$flatten$auto_429.$auto_428  = \$auto_428 ;
  assign \$flatten$auto_429.$auto_427  = \$auto_427 ;
  assign \$flatten$auto_429.$auto_426  = \$auto_426 ;
  assign \$auto_429.clk  = clk;
  assign clk_clk_buf = \$auto_429.clk_clk_buf ;
  assign clk_ibuf = \$auto_429.clk_ibuf ;
  assign \$auto_429.din  = din;
  assign din_ibuf = \$auto_429.din_ibuf ;
  assign dout = \$auto_429.dout ;
  assign \$auto_429.dout_obuf  = dout_obuf;
endmodule
