...
module sim(sim_trace, serial_source_valid, serial_source_ready, serial_source_data, serial_sink_valid, serial_sink_ready, serial_sink_data, sys_clk, i2c0_scl, i2c0_sda_out, i2c0_sda_in, gpio_oe, gpio_o, gpio_i);
  ...
  fabric_sim \$auto$rs_design_edit.cc:848:execute$286500  (
    .\main_out_storage[31] (main_out_storage[31]),
    .\main_out_storage[30] (main_out_storage[30]),
    .\main_out_storage[29] (main_out_storage[29]),
    .\main_out_storage[28] (main_out_storage[28]),
    .\main_out_storage[27] (main_out_storage[27]),
    .\main_out_storage[26] (main_out_storage[26]),
    .\main_out_storage[25] (main_out_storage[25]),
    .\main_out_storage[24] (main_out_storage[24]),
    .\main_out_storage[23] (main_out_storage[23]),
    .\main_out_storage[22] (main_out_storage[22]),
    .\main_out_storage[21] (main_out_storage[21]),
    .\main_out_storage[20] (main_out_storage[20]),
    .\main_out_storage[19] (main_out_storage[19]),
    .\main_out_storage[18] (main_out_storage[18]),
    .\main_out_storage[17] (main_out_storage[17]),
    .\main_out_storage[16] (main_out_storage[16]),
    .\main_out_storage[15] (main_out_storage[15]),
    .\main_out_storage[14] (main_out_storage[14]),
    .\main_out_storage[13] (main_out_storage[13]),
    .\main_out_storage[12] (main_out_storage[12]),
    .\main_out_storage[11] (main_out_storage[11]),
    .\main_out_storage[10] (main_out_storage[10]),
    .\main_out_storage[9] (main_out_storage[9]),
    .\main_out_storage[8] (main_out_storage[8]),
    .\main_out_storage[7] (main_out_storage[7]),
    .\main_out_storage[6] (main_out_storage[6]),
    .\main_out_storage[5] (main_out_storage[5]),
    .\main_out_storage[4] (main_out_storage[4]),
    .\main_out_storage[3] (main_out_storage[3]),
    .\main_out_storage[2] (main_out_storage[2]),
    .\main_out_storage[1] (main_out_storage[1]),
    .\main_out_storage[0] (main_out_storage[0]),
    .\main_oe_storage[30] (main_oe_storage[30]),
    .\main_oe_storage[29] (main_oe_storage[29]),
    .\main_oe_storage[28] (main_oe_storage[28]),
    .\main_oe_storage[27] (main_oe_storage[27]),
    .\main_oe_storage[26] (main_oe_storage[26]),
    .\main_oe_storage[25] (main_oe_storage[25]),
    .\main_oe_storage[24] (main_oe_storage[24]),
    .\main_oe_storage[23] (main_oe_storage[23]),
    .\main_oe_storage[22] (main_oe_storage[22]),
    .\main_oe_storage[21] (main_oe_storage[21]),
    .\main_oe_storage[20] (main_oe_storage[20]),
    .\main_oe_storage[19] (main_oe_storage[19]),
    .\main_oe_storage[18] (main_oe_storage[18]),
    .\main_oe_storage[17] (main_oe_storage[17]),
    .\main_oe_storage[16] (main_oe_storage[16]),
    .\main_oe_storage[15] (main_oe_storage[15]),
    .\main_oe_storage[14] (main_oe_storage[14]),
    .\main_oe_storage[13] (main_oe_storage[13]),
    .\main_oe_storage[12] (main_oe_storage[12]),
    .\main_oe_storage[11] (main_oe_storage[11]),
    .\main_oe_storage[10] (main_oe_storage[10]),
    .\main_oe_storage[9] (main_oe_storage[9]),
    .\main_oe_storage[8] (main_oe_storage[8]),
    .\main_oe_storage[7] (main_oe_storage[7]),
    .\main_oe_storage[6] (main_oe_storage[6]),
    .\main_oe_storage[5] (main_oe_storage[5]),
    .\main_oe_storage[4] (main_oe_storage[4]),
    .\main_oe_storage[3] (main_oe_storage[3]),
    .\main_oe_storage[2] (main_oe_storage[2]),
    .\main_oe_storage[1] (main_oe_storage[1]),
    .\main_oe_storage[0] (main_oe_storage[0]),
    .\main__w_storage[1] (main__w_storage[1]),
    .\main__w_storage[0] (main__w_storage[0]),
    .\$iopadmap$serial_source_data[6] (\$iopadmap$serial_source_data [6]),
    .\$iopadmap$serial_source_data[5] (\$iopadmap$serial_source_data [5]),
    .\$iopadmap$serial_source_data[4] (\$iopadmap$serial_source_data [4]),
    .\$iopadmap$serial_source_data[3] (\$iopadmap$serial_source_data [3]),
    .\$iopadmap$serial_source_data[2] (\$iopadmap$serial_source_data [2]),
    .\$iopadmap$serial_source_data[1] (\$iopadmap$serial_source_data [1]),
    .\$iopadmap$serial_source_data[0] (\$iopadmap$serial_source_data [0]),
    .\$iopadmap$serial_sink_data[6] (\$iopadmap$serial_sink_data [6]),
    .\$iopadmap$serial_sink_data[5] (\$iopadmap$serial_sink_data [5]),
    .\$iopadmap$serial_sink_data[4] (\$iopadmap$serial_sink_data [4]),
    .\$iopadmap$serial_sink_data[3] (\$iopadmap$serial_sink_data [3]),
    .\$iopadmap$serial_sink_data[2] (\$iopadmap$serial_sink_data [2]),
    .\$iopadmap$serial_sink_data[1] (\$iopadmap$serial_sink_data [1]),
    .\$iopadmap$serial_sink_data[0] (\$iopadmap$serial_sink_data [0]),
    .\$iopadmap$gpio_i[30] (\$iopadmap$gpio_i [30]),
    .\$iopadmap$gpio_i[29] (\$iopadmap$gpio_i [29]),
    .\$iopadmap$gpio_i[28] (\$iopadmap$gpio_i [28]),
    .\$iopadmap$gpio_i[27] (\$iopadmap$gpio_i [27]),
    .\$iopadmap$gpio_i[26] (\$iopadmap$gpio_i [26]),
    .\$iopadmap$gpio_i[25] (\$iopadmap$gpio_i [25]),
    .\$iopadmap$gpio_i[24] (\$iopadmap$gpio_i [24]),
    .\$iopadmap$gpio_i[23] (\$iopadmap$gpio_i [23]),
    .\$iopadmap$gpio_i[22] (\$iopadmap$gpio_i [22]),
    .\$iopadmap$gpio_i[21] (\$iopadmap$gpio_i [21]),
    .\$iopadmap$gpio_i[20] (\$iopadmap$gpio_i [20]),
    .\$iopadmap$gpio_i[19] (\$iopadmap$gpio_i [19]),
    .\$iopadmap$gpio_i[18] (\$iopadmap$gpio_i [18]),
    .\$iopadmap$gpio_i[17] (\$iopadmap$gpio_i [17]),
    .\$iopadmap$gpio_i[16] (\$iopadmap$gpio_i [16]),
    .\$iopadmap$gpio_i[15] (\$iopadmap$gpio_i [15]),
    .\$iopadmap$gpio_i[14] (\$iopadmap$gpio_i [14]),
    .\$iopadmap$gpio_i[13] (\$iopadmap$gpio_i [13]),
    .\$iopadmap$gpio_i[12] (\$iopadmap$gpio_i [12]),
    .\$iopadmap$gpio_i[11] (\$iopadmap$gpio_i [11]),
    .\$iopadmap$gpio_i[10] (\$iopadmap$gpio_i [10]),
    .\$iopadmap$gpio_i[9] (\$iopadmap$gpio_i [9]),
    .\$iopadmap$gpio_i[8] (\$iopadmap$gpio_i [8]),
    .\$iopadmap$gpio_i[7] (\$iopadmap$gpio_i [7]),
    .\$iopadmap$gpio_i[6] (\$iopadmap$gpio_i [6]),
    .\$iopadmap$gpio_i[5] (\$iopadmap$gpio_i [5]),
    .\$iopadmap$gpio_i[4] (\$iopadmap$gpio_i [4]),
    .\$iopadmap$gpio_i[3] (\$iopadmap$gpio_i [3]),
    .\$iopadmap$gpio_i[2] (\$iopadmap$gpio_i [2]),
    .\$iopadmap$gpio_i[1] (\$iopadmap$gpio_i [1]),
    .\$iopadmap$gpio_i[0] (\$iopadmap$gpio_i [0]),
    ...
    .\$iopadmap$gpio_i[31] (\$iopadmap$gpio_i [31]),
    .\$iopadmap$serial_sink_ready (\$iopadmap$serial_sink_ready ),
    .\$iopadmap$serial_sink_valid (\$iopadmap$serial_sink_valid ),
    .\$iopadmap$serial_sink_data[7] (\$iopadmap$serial_sink_data [7]),
    .\$iopadmap$serial_source_ready (\$iopadmap$serial_source_ready ),
    .\$iopadmap$serial_source_data[7] (\$iopadmap$serial_source_data [7]),
    .\main__w_storage[2] (main__w_storage[2]),
    .\main_oe_storage[31] (main_oe_storage[31]),
