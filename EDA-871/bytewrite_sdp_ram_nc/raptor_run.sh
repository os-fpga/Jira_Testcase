...
function simulate(){
    ...
    # bram_sim="/nfs_scratch/scratch/CompilerValidation/abdul_hameed/Compiler_Validation_vcs/RTL_testcases/Memory_Designs/rams_sp_re_we_rf_1024x32/brams_sim.v"
