...
simulate="" #      <simulator> <phase> ?<level>? <options> : Sets the simulator specific options for the specified phase
                      #     <phase> : compilation, elaboration, simulation, extra_options
                      #     <simulator>? ?<waveform_file>?: Simulates the design and testbench
...
#creating a tcl file to run raptor flow 
    ...
    echo "add_simulation_file ./sim/co_sim_tb/tb_$design.cpp ./sim/co_sim_tb/co_sim_$design.v" >> raptor_tcl.tcl
# ./rtl/$design.v 
    ##vary design to design
    ...
    echo "simulation_options compilation verilator rtl --timing -sc">>raptor_tcl.tcl
    ...
    echo "simulation_options compilation verilator gate --timing -sc">>raptor_tcl.tcl
    ...
    echo "simulation_options compilation verilator -DPNR=1 pnr --timing -sc">>raptor_tcl.tcl
