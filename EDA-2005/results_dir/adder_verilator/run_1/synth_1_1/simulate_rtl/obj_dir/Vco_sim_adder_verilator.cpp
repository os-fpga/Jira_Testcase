...
Vco_sim_adder_verilator::Vco_sim_adder_verilator(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new Vco_sim_adder_verilator__Syms(contextp(), _vcname__, this)}
    , rootp{&(vlSymsp->TOP)}
{
...
Vco_sim_adder_verilator::Vco_sim_adder_verilator(const char* _vcname__)
    : Vco_sim_adder_verilator(Verilated::threadContextp(), _vcname__)
{
}
...
void Vco_sim_adder_verilator::eval_end_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+eval_end_step Vco_sim_adder_verilator::eval_end_step\n"); );
#ifdef VM_TRACE
    // Tracing
...
const char* Vco_sim_adder_verilator::name() const {
    return vlSymsp->name();
}
