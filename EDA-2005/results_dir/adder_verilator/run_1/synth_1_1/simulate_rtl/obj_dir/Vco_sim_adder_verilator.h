...
class alignas(VL_CACHE_LINE_BYTES) Vco_sim_adder_verilator VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit Vco_sim_adder_verilator(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vco_sim_adder_verilator(const char* name = "TOP");
