...
bram_sim=`find $library -wholename "*/rapidsilicon/genesis2/brams_sim.v"`
    ...
    # TDP18K_FIFO="/nfs_scratch/scratch/CompilerValidation/abdul_hameed/Compiler_Validation_vcs/RTL_testcases/Memory_Designs/rams_sp_re_we_rf_1024x32/TDP18K_FIFO.v"
    ufifo_ctl=`find $library -wholename "*/rapidsilicon/genesis2/ufifo_ctl.v"`
    # sram1024x18="/nfs_scratch/scratch/CompilerValidation/abdul_hameed/Compiler_Validation_vcs/RTL_testcases/Memory_Designs/rams_sp_re_we_rf_1024x32/sram1024x18.v"
...
#reading log file of raptor to see is synthesis failed, if not failed staring the simulation
    ...
    then
        ...
        # vcs -sverilog $bram_sim $cell_path $lut_map /home/users/abdulhameed.akram/Documents/Compiler_validation_team/accumulator/primitives.v $TDP18K_FIFO $ufifo_ctl $sram1024x18 $design_path ../$design/$design\_post\_synthesis.v $tb_path +incdir+$directory_path -y $directory_path +libext+.v -full64 -debug_all 2>&1 | tee post_route_sim.log
