...
pnr_options="--place_algorithm congestion_aware --congest_tradeoff 160"  #VPR options
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ch_intrinsics.v">>raptor_tcl.tcl || echo ""
    ##vary design to design

    echo "set_top_module memset">>raptor_tcl.tcl 
