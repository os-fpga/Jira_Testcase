# Design
create_design neorv32_vhdl_pnr_tcl
...
add_design_file -VHDL_1993 -work neorv32 ./rtl/core/neorv32_slink.vhd
...
add_design_file -VHDL_1993 ./rtl/processor_templates/neorv32_ProcessorTop_UP5KDemo.vhd
add_design_file -VHDL_1993 ./rtl/processor_templates/neorv32_ProcessorTop_Minimal.vhd
add_design_file -VHDL_1993 ./rtl/processor_templates/neorv32_ProcessorTop_MinimalBoot.vhd
# add_design_file -VHDL_1993 rtl/system_integration/*.vhd
add_design_file -VHDL_1993 ./rtl/system_integration/neorv32_SystemTop_axi4lite.vhd
add_design_file -VHDL_1993 ./rtl/system_integration/neorv32_SystemTop_AvalonMM.vhd
add_design_file -VHDL_1993 ./rtl/system_integration/neorv32_litex_core_complex.vhd
add_design_file -VHDL_1993 ./rtl/system_integration/neorv32_ProcessorTop_stdlogic.vhd
# add_design_file -VHDL_1993 rtl/test_setups/*.vhd
add_design_file -VHDL_1993 ./rtl/test_setups/neorv32_test_setup_approm.vhd
add_design_file -VHDL_1993 ./rtl/test_setups/neorv32_test_setup_on_chip_debugger.vhd
add_design_file -VHDL_1993 ./rtl/test_setups/neorv32_test_setup_bootloader.vhd
#set design top
...
# Testbench
# adding package file here is simulation sources to circumvent EDA-1215
add_simulation_file -VHDL_1993 ./rtl/core/neorv32_package.vhd
add_simulation_file -VHDL_1993 ./sim/simple/uart_rx.simple.vhd
add_simulation_file -VHDL_1993 ./sim/simple/neorv32_tb.simple.vhd
...
# simulation_options "ghdl" "simulation" "--work=neorv32 --stop-time=1000ns"
# simulate "rtl" "ghdl" sim.vcd
...
# simulation_options "ghdl" "elaboration" "--work=neorv32"
# simulation_options "ghdl" "simulation" "--work=neorv32 --stop-time=1000ns"
# simulate "gate" "ghdl" sim_gate.vcd
