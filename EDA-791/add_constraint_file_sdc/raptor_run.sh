...
design="add_constraint_file_sdc"
...
add_constraint_file="./rtl/counter_sdc.sdc" #Sets SDC + location constraints  Constraints: set_pin_loc, set_mode, all SDC Standard commands
