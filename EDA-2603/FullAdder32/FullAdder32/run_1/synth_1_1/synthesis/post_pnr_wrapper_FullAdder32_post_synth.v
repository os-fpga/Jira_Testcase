...
module FullAdder32(a, b, cin, sum, cout);
  ...
  (* src = "/nfs_scratch/scratch/CompilerValidation/zaheer_ahmad/FullAdder32/./rtl/FullAdder32.v:5.24-5.27" *)
  wire [31:0] sum;
  fabric_FullAdder32 \$auto$rs_design_edit.cc:656:execute$5219  (
    .\$iopadmap$sum[31] (\$iopadmap$sum [31]),
    .\$iopadmap$sum[30] (\$iopadmap$sum [30]),
    .\$iopadmap$sum[29] (\$iopadmap$sum [29]),
    .\$iopadmap$sum[28] (\$iopadmap$sum [28]),
    .\$iopadmap$sum[27] (\$iopadmap$sum [27]),
    .\$iopadmap$sum[26] (\$iopadmap$sum [26]),
    .\$iopadmap$sum[25] (\$iopadmap$sum [25]),
    .\$iopadmap$sum[24] (\$iopadmap$sum [24]),
    .\$iopadmap$sum[23] (\$iopadmap$sum [23]),
    .\$iopadmap$sum[22] (\$iopadmap$sum [22]),
    .\$iopadmap$sum[21] (\$iopadmap$sum [21]),
    .\$iopadmap$sum[20] (\$iopadmap$sum [20]),
    .\$iopadmap$sum[19] (\$iopadmap$sum [19]),
    .\$iopadmap$sum[18] (\$iopadmap$sum [18]),
    .\$iopadmap$sum[17] (\$iopadmap$sum [17]),
    .\$iopadmap$sum[16] (\$iopadmap$sum [16]),
    .\$iopadmap$sum[15] (\$iopadmap$sum [15]),
    .\$iopadmap$sum[14] (\$iopadmap$sum [14]),
    .\$iopadmap$sum[13] (\$iopadmap$sum [13]),
    .\$iopadmap$sum[12] (\$iopadmap$sum [12]),
    .\$iopadmap$sum[11] (\$iopadmap$sum [11]),
    .\$iopadmap$sum[10] (\$iopadmap$sum [10]),
    .\$iopadmap$sum[9] (\$iopadmap$sum [9]),
    .\$iopadmap$sum[8] (\$iopadmap$sum [8]),
    .\$iopadmap$sum[7] (\$iopadmap$sum [7]),
    .\$iopadmap$sum[6] (\$iopadmap$sum [6]),
    .\$iopadmap$sum[5] (\$iopadmap$sum [5]),
    .\$iopadmap$sum[4] (\$iopadmap$sum [4]),
    .\$iopadmap$sum[3] (\$iopadmap$sum [3]),
    .\$iopadmap$sum[2] (\$iopadmap$sum [2]),
    .\$iopadmap$sum[1] (\$iopadmap$sum [1]),
    .\$iopadmap$sum[0] (\$iopadmap$sum [0]),
    .\$iopadmap$b[30] (\$iopadmap$b [30]),
    .\$iopadmap$b[29] (\$iopadmap$b [29]),
    .\$iopadmap$b[28] (\$iopadmap$b [28]),
    .\$iopadmap$b[27] (\$iopadmap$b [27]),
    .\$iopadmap$b[26] (\$iopadmap$b [26]),
    .\$iopadmap$b[25] (\$iopadmap$b [25]),
    .\$iopadmap$b[24] (\$iopadmap$b [24]),
    .\$iopadmap$b[23] (\$iopadmap$b [23]),
    .\$iopadmap$b[22] (\$iopadmap$b [22]),
    .\$iopadmap$b[21] (\$iopadmap$b [21]),
    .\$iopadmap$b[20] (\$iopadmap$b [20]),
    ...
    .\$iopadmap$a[30] (\$iopadmap$a [30]),
    .\$iopadmap$a[29] (\$iopadmap$a [29]),
    .\$iopadmap$a[28] (\$iopadmap$a [28]),
    ...
    .\$iopadmap$a[31] (\$iopadmap$a [31]),
    .\$iopadmap$cin (\$iopadmap$cin ),
    .\$iopadmap$cout (\$iopadmap$cout ),
    .\$iopadmap$b[31] (\$iopadmap$b [31])
  );
  interface_FullAdder32 \$auto$rs_design_edit.cc:658:execute$5220  (
