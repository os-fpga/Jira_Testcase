...
assign sys_clk = clk;
assign dout_B_1[17:0] = bram_out_B[17:0];
//------------------------------------------------------------------------------
// Synchronous Logic
//------------------------------------------------------------------------------
...
RS_TDP36K #(
	.INIT_i(36864'b100110011010101010001100001001010011010101011011001001110110111101110110101011101110010010),
	.MODE_BITS(81'b001001001001000000000000000000000000000000010010010010000000000000000000000000001)
) RS_TDP36K (
	.ADDR_B1({addr_B_1[2:0], {4{1'd0}}}),
	.ADDR_B2({addr_B_1[2:0], {4{1'd0}}}),
	.BE_A1(0),
	.BE_A2(0),
	.CLK_A1(0),
	.CLK_A2(0),
