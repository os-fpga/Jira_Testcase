...
void Vco_sim_accum_20lsb_input_to_mulltiplier_new_primitive___024root___eval_triggers__act(Vco_sim_accum_20lsb_input_to_mulltiplier_new_primitive___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vco_sim_accum_20lsb_input_to_mulltiplier_new_primitive___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__clk__0))) 
                                     | ((IData)(vlSelf->co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__reset) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__reset__0)))));
    vlSelf->__VactTriggered.set(1U, vlSelf->__VdlySched.awaitingCurrentTime());
    vlSelf->__VactTriggered.set(2U, ((~ (IData)(vlSelf->co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__clk)) 
                                     & (IData)(vlSelf->__Vtrigprevexpr___TOP__co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__clk__0)));
    vlSelf->__VactTriggered.set(3U, ((IData)(vlSelf->co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__co_sim_accum_20lsb_input_to_mulltiplier_new_primitive__DOT__clk__0))));
