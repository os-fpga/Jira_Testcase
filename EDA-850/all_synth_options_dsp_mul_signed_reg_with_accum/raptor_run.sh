...
design="all_synth_options_dsp_mul_signed_reg_with_accum"
...
set_limits_bram="bram 0"
set_limits_dsp="dsp 0"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$set_limits_bram" ] && echo "" || echo "set_limits $set_limits_bram">>raptor_tcl.tcl
    [ -z "$set_limits_dsp" ] && echo "" || echo "set_limits $set_limits_dsp">>raptor_tcl.tcl
