    ...
    , TOP{this, namep}
{
    ...
    // Setup scopes
    __Vscope_co_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2__golden__DSP_inst.configure(this, name(), "co_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2.golden.DSP_inst", "DSP_inst", -9, VerilatedScope::SCOPE_OTHER);
}
