    ...
    , TOP{this, namep}
{
    ...
    // Setup scopes
    __Vscope_co_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2__netlist__RS_DSP_MULTADD_REGIN_z_out__05b1__05d__genblk1__DSP19X2_MULTADD_REGIN.configure(this, name(), "co_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2.netlist.RS_DSP_MULTADD_REGIN_z_out[1].genblk1.DSP19X2_MULTADD_REGIN", "DSP19X2_MULTADD_REGIN", -9, VerilatedScope::SCOPE_OTHER);
}
