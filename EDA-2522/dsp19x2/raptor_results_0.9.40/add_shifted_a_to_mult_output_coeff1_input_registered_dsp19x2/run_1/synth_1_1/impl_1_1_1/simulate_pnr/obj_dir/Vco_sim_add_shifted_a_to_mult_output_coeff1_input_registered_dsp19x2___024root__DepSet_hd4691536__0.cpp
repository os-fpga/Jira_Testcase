...
VL_INLINE_OPT VlCoroutine Vco_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2___024root___eval_initial__TOP__2(Vco_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2___024root* vlSelf) {
    ...
    while (1U) {
        co_await vlSelf->__VtrigSched_hc605704e__0.trigger(0U, 
                                                           ...
                                                           "/nfs_eda_sw/softwares/Raptor/instl_dir/02_17_2024_09_15_01/share/raptor/sim_models/rapidsilicon/genesis3/FPGA_PRIMITIVES_MODELS/sim_models/verilog/DSP19X2.v", 
                                                           381);
        if (VL_UNLIKELY((0x15U < (IData)(vlSelf->co_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2__DOT__acc_fir)))) {
            VL_WRITEF("WARNING: DSP19x2 instance %Nco_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2.netlist.RS_DSP_MULTADD_REGIN_z_out[1].genblk1.DSP19X2_MULTADD_REGIN ACC_FIR input is %2# which is greater than 21 which serves no function\n",
                      vlSymsp->name(),5,vlSelf->co_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2__DOT__acc_fir);
            co_await vlSelf->__VdlySched.delay(0x3e8ULL, 
                                               nullptr, 
                                               "/nfs_eda_sw/softwares/Raptor/instl_dir/02_17_2024_09_15_01/share/raptor/sim_models/rapidsilicon/genesis3/FPGA_PRIMITIVES_MODELS/sim_models/verilog/DSP19X2.v", 
                                               385);
            VL_FINISH_MT("/nfs_eda_sw/softwares/Raptor/instl_dir/02_17_2024_09_15_01/share/raptor/sim_models/rapidsilicon/genesis3/FPGA_PRIMITIVES_MODELS/sim_models/verilog/DSP19X2.v", 385, "");
        }
    }
}
