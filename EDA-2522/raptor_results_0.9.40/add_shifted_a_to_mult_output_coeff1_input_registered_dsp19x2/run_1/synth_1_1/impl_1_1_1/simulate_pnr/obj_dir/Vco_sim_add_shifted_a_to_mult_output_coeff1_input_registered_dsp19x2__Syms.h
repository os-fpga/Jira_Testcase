...
class alignas(VL_CACHE_LINE_BYTES)Vco_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2__Syms final : public VerilatedSyms {
  public:
    ...
    // SCOPE NAMES
    VerilatedScope __Vscope_co_sim_add_shifted_a_to_mult_output_coeff1_input_registered_dsp19x2__netlist__RS_DSP_MULTADD_REGIN_z_out__05b1__05d__genblk1__DSP19X2_MULTADD_REGIN;
