...
set_io     o_delay_i              HP_1_0_0P             -mode          MODE_BP_DIR_A_RX -internal_pin g2f_rx_in[0]_A

# Pin      dout                   :: O_DELAY |-> O_BUFT
# set_mode MODE_BP_DIR_B_TX       HP_1_1_0N
# set_io   dout                   HP_1_1_0N             --> (original)
set_io     $auto_431              HP_1_0_0P             -mode          MODE_BP_DIR_B_TX -internal_pin f2g_tx_out[5]_A
...
set_io   $auto_413                             HR_1_1_0N     -mode MODE_BP_DIR_B_RX -internal_pin f2g_in_en_B
...
# Port: EN
# Signal: in:f2g_in_en_{A|B}
set_io   $auto_414                             HR_1_3_1N     -mode MODE_BP_DIR_B_RX -internal_pin f2g_in_en_B
...
# Port: EN
# Signal: in:f2g_in_en_{A|B}
set_io   $auto_415                             HR_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin f2g_in_en_A
...
# Port: EN
# Signal: in:f2g_in_en_{A|B}
set_io   $auto_416                             HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin f2g_in_en_A
...
# Remap location from HP_1_0_0P to HP_1_0_0P
set_io   $f2g_trx_dly_inc_$ibuf_delay_incdec_2 HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin f2g_trx_dly_inc
...
# Remap location from HP_1_0_0P to HP_1_0_0P
set_io   $f2g_trx_dly_ld_$ibuf_delay_load_2    HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin f2g_trx_dly_ld
...
# Remap location from HP_1_0_0P to HP_1_0_0P
set_io   $ifab_$obuf_i_delay_value[0]          HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin g2f_trx_dly_tap[0]
set_io   $ifab_$obuf_i_delay_value[1]          HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin g2f_trx_dly_tap[1]
set_io   $ifab_$obuf_i_delay_value[2]          HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin g2f_trx_dly_tap[2]
set_io   $ifab_$obuf_i_delay_value[3]          HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin g2f_trx_dly_tap[3]
set_io   $ifab_$obuf_i_delay_value[4]          HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin g2f_trx_dly_tap[4]
set_io   $ifab_$obuf_i_delay_value[5]          HP_1_0_0P     -mode MODE_BP_DIR_A_RX -internal_pin g2f_trx_dly_tap[5]
...
set_io   $auto_417                             HP_1_1_0N     -mode MODE_BP_DIR_B_TX -internal_pin f2g_tx_oe_B
...
# set_io $f2g_trx_dly_adj_$ibuf_delay_adj      HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin f2g_trx_dly_adj
...
# set_io $f2g_trx_dly_inc_$ibuf_delay_incdec   HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin f2g_trx_dly_inc
...
# set_io $f2g_trx_dly_ld_$ibuf_delay_load      HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin f2g_trx_dly_ld
...
# set_io $ifab_$obuf_o_delay_value[0]          HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin g2f_trx_dly_tap[0]
# set_io $ifab_$obuf_o_delay_value[1]          HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin g2f_trx_dly_tap[1]
# set_io $ifab_$obuf_o_delay_value[2]          HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin g2f_trx_dly_tap[2]
# set_io $ifab_$obuf_o_delay_value[3]          HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin g2f_trx_dly_tap[3]
# set_io $ifab_$obuf_o_delay_value[4]          HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin g2f_trx_dly_tap[4]
# set_io $ifab_$obuf_o_delay_value[5]          HP_1_0_0P     -mode MODE_BP_DIR_B_TX -internal_pin g2f_trx_dly_tap[5]
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_418                             HR_5_0_0P     -mode MODE_BP_DIR_A_TX -internal_pin f2g_tx_oe_A
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_419                             HR_5_1_0N     -mode MODE_BP_DIR_B_TX -internal_pin f2g_tx_oe_B
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_420                             HR_5_2_1P     -mode MODE_BP_DIR_A_TX -internal_pin f2g_tx_oe_A
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_421                             HR_5_3_1N     -mode MODE_BP_DIR_B_TX -internal_pin f2g_tx_oe_B
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_422                             HR_5_4_2P     -mode MODE_BP_DIR_A_TX -internal_pin f2g_tx_oe_A
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_423                             HR_5_5_2N     -mode MODE_BP_DIR_B_TX -internal_pin f2g_tx_oe_B
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_424                             HR_5_6_3P     -mode MODE_BP_DIR_A_TX -internal_pin f2g_tx_oe_A
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_425                             HR_5_7_3N     -mode MODE_BP_DIR_B_TX -internal_pin f2g_tx_oe_B
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_426                             HR_5_8_4P     -mode MODE_BP_DIR_A_TX -internal_pin f2g_tx_oe_A
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_427                             HR_5_9_4N     -mode MODE_BP_DIR_B_TX -internal_pin f2g_tx_oe_B
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_428                             HR_5_CC_18_9P -mode MODE_BP_DIR_A_TX -internal_pin f2g_tx_oe_A
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_429                             HR_5_CC_19_9N -mode MODE_BP_DIR_B_TX -internal_pin f2g_tx_oe_B
...
# Port: EN
# Signal: in:f2g_in_en_{A|B}
set_io   $auto_430                             HP_1_CC_18_9P -mode MODE_BP_DIR_A_RX -internal_pin f2g_in_en_A
