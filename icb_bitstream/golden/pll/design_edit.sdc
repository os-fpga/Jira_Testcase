...
# set_clock_pin -device_clock clk[0] -design_clock clk (Physical port name, clock module: PLL pll)
# set_clock_pin -device_clock clk[0] -design_clock pll_clk (Original clock primitive out-net to fabric)
set_clock_pin   -device_clock clk[0] -design_clock pll_clk
...
#
#############
# Object clk is primitive \PLL but data signal is not defined
# Pin      clk              :: I_BUF |-> CLK_BUF |-> PLL
...
set_io   $auto_415 HP_1_CC_18_9P -mode MODE_BP_DIR_A_RX -internal_pin f2g_in_en_A
...
# set_io $auto_418 HP_1_CC_18_9P -mode MODE_BP_DIR_A_RX -internal_pin TO_BE_DETERMINED
