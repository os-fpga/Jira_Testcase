...
set_io     o_ddr_d          HP_1_4_2P             -mode          MODE_BP_DDR_A_RX -internal_pin g2f_rx_in[0]_A
set_io     $delete_wire$399 HP_1_4_2P             -mode          MODE_BP_DDR_A_RX -internal_pin g2f_rx_in[1]_A

# Skip this because 'This is secondary pin. But IO bitstream generation will still make sure it is used in pair. Otherwise the IO bitstream will be invalid'
# Pin      dout_n           :: O_DDR |-> O_BUF_DS

# Pin      dout_p           :: O_DDR |-> O_BUF_DS
# set_mode MODE_BP_DDR_A_TX HP_1_6_3P
# set_io   dout_p           HP_1_6_3P             --> (original)
set_io     $auto_404        HP_1_6_3P             -mode          MODE_BP_DDR_A_TX -internal_pin f2g_tx_out[0]_A
# set_io   __const_bit_0__  HP_1_6_3P             -mode          MODE_BP_DDR_A_TX -internal_pin f2g_tx_out[1]_A
...
# Port: EN
# Signal: in:f2g_in_en_{A|B}
set_io   $auto_403                        HP_1_4_2P     -mode MODE_BP_DDR_A_RX -internal_pin f2g_in_en_A
...
# set_io $ofab_$ibuf_enable_2             HP_1_4_2P     -mode MODE_BP_DDR_A_RX -internal_pin TO_BE_DETERMINED
...
# Signal: in:TO_BE_DETERMINED
# Skip reason: TO_BE_DETERMINED
# set_io $f2g_trx_reset_n_A_$ibuf_reset_2 HP_1_4_2P     -mode MODE_BP_DDR_A_RX -internal_pin TO_BE_DETERMINED
...
# Signal: in:TO_BE_DETERMINED
# Skip reason: TO_BE_DETERMINED
# set_io $ofab_$ibuf_enable               HP_1_6_3P     -mode MODE_BP_DDR_A_TX -internal_pin TO_BE_DETERMINED
...
# Signal: in:TO_BE_DETERMINED
# Skip reason: TO_BE_DETERMINED
# set_io $f2g_trx_reset_n_A_$ibuf_reset   HP_1_6_3P     -mode MODE_BP_DDR_A_TX -internal_pin TO_BE_DETERMINED
